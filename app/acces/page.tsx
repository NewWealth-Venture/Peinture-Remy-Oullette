...
function AccesFormFallback() {
  return (
    <div className="w-full max-w-sm bg-neutral-white border border-neutral-border rounded-lg shadow-sm p-6">
      ...
      <div className="h-10 px-3 border border-neutral-border rounded bg-neutral-bg-subtle animate-pulse" />
      <div className="h-10 bg-neutral-bg-subtle rounded animate-pulse mt-4" />
    </div>
  );
}
...
export default function AccesPage() {
  return (
    <div className="min-h-screen flex items-center justify-center bg-neutral-bg-subtle px-4">
      <Suspense fallback={<AccesFormFallback />}>
        <AccesForm />
      </Suspense>
    </div>
  );
